...
public class MainInterface {
    public static void main(String[] args) {
        ...
        Jogador jogador1 = new Jogador("Lucas", deckJ1, 100, 100, 9, scanner);
        Jogador jogador2 = new Jogador("Renan", deckJ2, 100, 100, 9, scanner);
        ...
        controladorJogo.getJogar().iniciar();
    }
}
